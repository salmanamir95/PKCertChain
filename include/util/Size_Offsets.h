...
#define MINI_POW_CHALLENGE_SIZE (UINT256_SIZE + UINT8_SIZE + UINT64_SIZE + 3 * UINT8_SIZE) // 44 bytes
#define MINI_POW_SOLVE_SIZE (UINT64_SIZE + UINT8_SIZE + UINT64_SIZE + 3 * UINT8_SIZE) // 20 bytes
#define TIER_POW_CHALLENGE_SIZE MINI_POW_CHALLENGE_SIZE
#define TIER_POW_SOLVE_SIZE MINI_POW_SOLVE_SIZE
#define PK_CERT_CHAIN_SIZE (100*BLOCK_SIZE + UINT32_SIZE)
