...
#define MINI_POW_CHALLENGE_SIZE (UINT256_SIZE + 4 * UINT16_SIZE + UINT64_SIZE + 2 * UINT8_SIZE) // 52 bytes
#define MINI_POW_SOLVE_SIZE (4 * UINT16_SIZE + 3 * UINT64_SIZE) // 40 bytes
